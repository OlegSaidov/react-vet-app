                ...
                {this.props.appointments.map(item => (
                    <div className="pet-item col media py-3" key={item.aptId}>
                        ...
                        <div className="pet-info media-body">
                            ...
                            <div className="apt-notes"><FaNotesMedical className="m-2" style={{color:"#337ab7", fontSize: 1.5 + "em"}}/><span contentEditable suppressContentEditableWarning
                            onBlur={e=>this.props.updateInfo("aptNotes", e.target.innerText, item.aptId)}
                            >{item.aptNotes}</span></div>
                        </div>
                    </div>
